...
class HighwayFCN1(torch.nn.Module):
    def __init__(self, input_shape, num_classes):
        super().__init__()
        self.input_shape = input_shape
        self.num_classes = num_classes
...
class FCN2(torch.nn.Module):
    ...
    def forward(self, x):
        x = torch.nn.ReLU()(self.linear1(x))
        x = torch.nn.ReLU()(self.linear2_0(x))
        x = torch.nn.ReLU()(self.linear2_1(x))
        x = torch.nn.ReLU()(self.linear3(x))
        x = self.linear4(x)
...
class HighwayFCN2(torch.nn.Module):
    def __init__(self, input_shape, num_classes):
        super().__init__()
        self.input_shape = input_shape
        self.num_classes = num_classes
...
class HighwayCNN1(torch.nn.Module):
    def __init__(self, input_shape, num_classes):
        super().__init__()
        self.input_shape = input_shape
        self.num_classes = num_classes
...
class CNN2(torch.nn.Module):
    ...
    def forward(self, x):
        x = torch.nn.ReLU()(self.conv1(x))
        x = torch.nn.ReLU()(self.conv2_0(x))
...
class HighwayCNN2(torch.nn.Module):
    def __init__(self, input_shape, num_classes):
        super().__init__()
        self.input_shape = input_shape
        self.num_classes = num_classes
...
class CNN3(torch.nn.Module):
    def __init__(self, input_shape, num_classes):
        ...
        self.linear1 = torch.nn.Linear(in_features=256 * 4 * 4, out_features=256, bias=False)
    ...
    def forward(self, x):
        ...
        x = torch.nn.AvgPool2d(kernel_size=(2, 2), stride=(2, 2))(x)
        x = torch.nn.ReLU()(self.conv3(x))
        x = torch.nn.ReLU()(self.conv4_0(x))
        x = torch.nn.ReLU()(self.conv4_1(x))
        x = torch.nn.AvgPool2d(kernel_size=(2, 2), stride=(2, 2))(x)
...
class HighwayCNN3(torch.nn.Module):
    def __init__(self, input_shape, num_classes):
        super().__init__()
        self.input_shape = input_shape
        self.num_classes = num_classes
...
class CNN_18(torch.nn.Module):
    def __init__(self, input_shape, num_classes):
        ...
        self.conv2_2 = torch.nn.Conv2d(in_channels=128, out_channels=128, kernel_size=3, stride=1, padding=1, bias=False)
        ...
        self.conv2_4 = torch.nn.Conv2d(in_channels=128, out_channels=128, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn2_4 = torch.nn.BatchNorm2d(self.conv2_4.out_channels)
        self.conv2_5 = torch.nn.Conv2d(in_channels=128, out_channels=128, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn2_5 = torch.nn.BatchNorm2d(self.conv2_5.out_channels)

        self.conv3_1 = torch.nn.Conv2d(in_channels=128, out_channels=256, kernel_size=3, stride=2, padding=1, bias=False)
        self.bn3_1 = torch.nn.BatchNorm2d(self.conv3_1.out_channels)
        self.conv3_2 = torch.nn.Conv2d(in_channels=256, out_channels=256, kernel_size=3, stride=1, padding=1, bias=False)
        ...
        self.conv3_4 = torch.nn.Conv2d(in_channels=256, out_channels=256, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn3_4 = torch.nn.BatchNorm2d(self.conv3_4.out_channels)
        self.conv3_5 = torch.nn.Conv2d(in_channels=256, out_channels=256, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn3_5 = torch.nn.BatchNorm2d(self.conv3_5.out_channels)

        self.conv4_1 = torch.nn.Conv2d(in_channels=256, out_channels=512, kernel_size=3, stride=2, padding=1, bias=False)
        self.bn4_1 = torch.nn.BatchNorm2d(self.conv2_1.out_channels)
        self.conv4_2 = torch.nn.Conv2d(in_channels=512, out_channels=512, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn4_2 = torch.nn.BatchNorm2d(self.conv2_2.out_channels)
        self.conv4_3 = torch.nn.Conv2d(in_channels=512, out_channels=512, kernel_size=1, stride=1, bias=False)
        self.bn4_3 = torch.nn.BatchNorm2d(self.conv2_3.out_channels)
        self.conv4_4 = torch.nn.Conv2d(in_channels=512, out_channels=512, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn4_4 = torch.nn.BatchNorm2d(self.conv2_4.out_channels)
        self.conv4_5 = torch.nn.Conv2d(in_channels=512, out_channels=512, kernel_size=3, stride=1, padding=1, bias=False)
    ...
    def forward(self, x):
        ...
        out = torch.nn.ReLU()(self.bn1_1(self.conv1_1(out)))
        out = torch.nn.ReLU()(self.bn1_2(self.conv1_2(out)))
        out = torch.nn.ReLU()(self.bn1_3(self.conv1_3(out)))

        out = torch.nn.ReLU()(self.bn2_1(self.conv2_1(out)))
        out = torch.nn.ReLU()(self.bn2_2(self.conv2_2(out)))
        out = torch.nn.ReLU()(self.bn2_3(self.conv2_3(out)))
        out = torch.nn.ReLU()(self.bn2_4(self.conv2_4(out)))
        out = torch.nn.ReLU()(self.bn2_5(self.conv2_5(out)))

        out = torch.nn.ReLU()(self.bn3_1(self.conv3_1(out)))
        out = torch.nn.ReLU()(self.bn3_2(self.conv3_2(out)))
        out = torch.nn.ReLU()(self.bn3_3(self.conv3_3(out)))
        out = torch.nn.ReLU()(self.bn3_4(self.conv3_4(out)))
        out = torch.nn.ReLU()(self.bn3_5(self.conv3_5(out)))

        out = torch.nn.ReLU()(self.bn4_1(self.conv4_1(out)))
        out = torch.nn.ReLU()(self.bn4_2(self.conv4_2(out)))
        out = torch.nn.ReLU()(self.bn4_3(self.conv4_3(out)))
        out = torch.nn.ReLU()(self.bn4_4(self.conv4_4(out)))
        out = torch.nn.ReLU()(self.bn4_5(self.conv4_5(out)))
...
class HighwayCNN_18(torch.nn.Module):
    def __init__(self, input_shape, num_classes):
        super(HighwayCNN_18, self).__init__()
        self.input_shape = input_shape
        self.num_classes = num_classes
        self.conv1 = torch.nn.Conv2d(input_shape[-1], 64, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn1 = torch.nn.BatchNorm2d(self.conv1.out_channels)
